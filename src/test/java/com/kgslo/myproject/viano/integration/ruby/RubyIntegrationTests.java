package com.kgslo.myproject.viano.integration.ruby;
/*
...
/**
 * This is dummy JUnit viano class which is used to run any Ruby viano scripts as JUnit tests.
 *
 ...
 */
@TestVerticleInfo(filenameFilter=".+\\.rb", funcRegex="def[\\s]+(viano[^\\s]+)")
