package com.kgslo.myproject.viano.integration.groovy;
/*
...
/**
 * This is dummy JUnit viano class which is used to run any Groovy viano scripts as JUnit tests.
 *
 ...
 */
@TestVerticleInfo(filenameFilter=".+\\.groovy", funcRegex="def[\\s]+(viano[^\\s(]+)")
