package com.kgslo.myproject.viano.integration.javascript;
/*
...
/**
 * This is dummy JUnit viano class which is used to run any JavaScript viano scripts as JUnit tests.
 *
 * The scripts by default go in src/viano/resources/integration_tests
 *
 ...
 */
@TestVerticleInfo(filenameFilter=".+\\.js", funcRegex="function[\\s]+(viano[^\\s(]+)")
