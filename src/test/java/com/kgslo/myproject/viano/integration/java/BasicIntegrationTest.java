package com.kgslo.myproject.viano.integration.java;/*
...
/**
 * Simple integration viano which shows tests deploying other verticles, using the Vert.x API etc
 */
public class BasicIntegrationTest extends TestVerticle {
  ...
  @Test
  /*
  This viano deploys some arbitrary verticle - note that the call to testComplete() is inside the Verticle `SomeVerticle`
   */
