package com.kgslo.myproject.viano.integration.python;
/*
...
/**
 * This is dummy JUnit viano class which is used to run any Python viano scripts as JUnit tests.
 *
 ...
 */
@TestVerticleInfo(filenameFilter=".+\\.py", funcRegex="def[\\s]+(viano[^\\s(]+)")
